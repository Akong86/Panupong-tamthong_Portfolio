...
### 1. 🏞️ Chiang Mai PAO Park Market Analysis
...
- **Key File:** `01-PAO-Park-Market-Analysis/web_scraping_script.py`
...
- **Key File:** `02-Onyx-Business-Case/onyx_business_case.pdf`
...
Files: Dashboard CI.pbix, case study manufacturing.pdf 
Designed a comprehensive Manufacturing Dashboard to monitor a fleet of 10,000 machines with a 3.39% failure rate.
Utilized Correlation Analysis to identify mechanical and thermal patterns, specifically finding that Heat Dissipation is the primary root cause of breakdowns.
Developed Predictive Insights by establishing baselines for Torque-Speed (Inverse Relationship) and Process-Air Temperature (Linear Correlation) to detect overheating outliers.
